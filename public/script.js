...
async function renderizarClientes() {
  ...
  try {
    ...
    clientesPagina.forEach(cliente => {
      ...
      <td>${cliente.data_entrada ? new Date(cliente.data_entrada + 'T00:00:00-03:00').toLocaleDateString('pt-BR') : ''}</td>
      <td>${cliente.data_saida ? new Date(cliente.data_saida + 'T00:00:00-03:00').toLocaleDateString('pt-BR') : ''}</td>
